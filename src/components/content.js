...
class Content extends React.Component {
		...
		article: [
			{
				...
				date: " 2014 год",
				production: "https://css.labirint.ru/t/21990/tild3065-3861-4136-a131-646331366235__Piter.png",
				// img: {JS}
    ...
    render(){
		const select = this.state.selected !== null ? <Aside  h2 = {this.state.selected.h2} img = {this.state.selected.img} text = {this.state.selected.text} /> : <div>nope</div>;
        ...
        return(
            <main className="row">
				<section className="col-8">
					...
					<br/>
					<button onClick={this.buttonClick}>{this.state.button}</button>
					<br/>
								...
								<div>
									{
										...
										: <ContentItem key={iterator.id}  h2 = {iterator.h2} />
									}
    ...
    buttonClick = () => {
    	this.state.button === "СВЕРНУТЬ" ? this.setState({button: "РАЗВЕРНУТЬ"}) : this.setState({button: "СВЕРНУТЬ"});
    };
